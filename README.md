...
| 분석 항목 | Llama-4-Scout-17B | Llama-3.3-70B-Instruct | Qwen2.5-32B | **Qwen3-0.6B** | Mistral-Small-3.1-24B-Base-2503 | HyperCLOVAX-SEED-Vision-Instruct-3B | solar-pro2-tokenizer  |
|-----------|------------------|------------------------|-------------|---------------|----------------------------------|-------------------------------------|-----------------------|
| 분석 대상 최대 토큰 ID | 201,135 | 128,256 | 151,665 | **151,669** | 131,072 | 110,524 | 196,608 | 
| 분석 대상 토큰 수 | 201,032 | 128,153 | 151,562 | **151,566** | 130,969 | 110,421 | 196,505 | 
| 순수 영문 토큰 수 | 36,668 | 28,158 | 27,376 | **27,376** | 22,447 | 27,343 | 22,447 | 22,447 | 
| 한글 가능성 토큰 수 | 64,992 | 25,738 | 53,204 | **53,204** | 41,124 | 13,919 | 104,388 | 
| 완성형 한글 포함 토큰 수 | 5,490 | 2,281 | 3,498 | **3,498** | 4,492 | 10,067 | 58,089 |
| 특수문자 토큰 수 | 2,509 | 2,588 | 2,579 | **2,579** | 1,500 | 2,526 | 68,230 | 1,523 |
| 미분류 토큰 수 | 97,009 | 71,806 | 68,592 | **68,596** | 65,958 | 66,768 | 68,230 | 
